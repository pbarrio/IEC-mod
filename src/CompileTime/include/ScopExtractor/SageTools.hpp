...
private:
  ...
  // static SideEffectAnalysis* rose_sideeffect;

  // static bool sideEffectAnalysis_done;
...
public:
  ...
  static
  bool
  isMathFunc(SgFunctionSymbol* node,std::vector<SgFunctionSymbol*>& call_stack);

  static
  bool 
  checkFunctionBody(SgFunctionDeclaration*,std::vector<SgFunctionSymbol*>& call_stack);
  ...
  // static
  // void
  // doSideEffectAnalysis(SgProject&);
